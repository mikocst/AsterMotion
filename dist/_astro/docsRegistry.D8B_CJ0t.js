...
\r
export default Accordion`,ge=`import React from 'react'\r
...
\r
export default Badge`,fe=`import { motion} from 'motion/react';\r
...
\r
export default Switch`,be=`import {AnimatePresence, motion} from 'motion/react';
...
export default Tabs`,ve=`import { cn } from "src/lib/utils"\r
...
\r
export default Input`,xe=`import {useEffect, useRef, useState} from "react";\r
import {AnimatePresence, motion} from 'motion/react';\r
...
\r
export default Modal`,ye=`import React from 'react'\r
...
\r
export default Breadcrumb`,we=`import React from 'react'\r
import type { BreadcrumbItem } from './types'\r
...
\r
export default BreadcrumbStart`,Ie=`import React from 'react'\r
import type { BreadcrumbItem } from './types'\r
import { ChevronRight } from 'lucide-react'\r
\r
...
\r
export default BreadcrumbStandard`,Ce=`import type { BreadcrumbItem } from "./types"\r
import { ChevronRight } from "lucide-react"\r
\r
...
\r
export default Card`,Re=`import React from 'react'\r
import { cn } from 'src/lib/utils'\r
\r
...
\r
export default CardHeader`,Te=`import React from 'react'\r
import { cn } from 'src/lib/utils'\r
\r
...
\r
export default CardTitle`,Ne=`import React from 'react'\r
import { cn } from 'src/lib/utils'\r
\r
...
\r
export default CardDescription`,ke=`import { cn } from 'src/lib/utils'\r
\r
...
\r
export default CardFooter`,Se=`import Button from "@components/Button";\r
...
\r
export default Carousel`,De=`import React from 'react'\r
...
\r
export default CarouselContent`,Be=`import { useContext, useId, useEffect } from 'react';\r
...
\r
export default CarouselItem`,Me=`import React from 'react'\r
...
\r
export default Pagination`,Ae=`import { usePagination } from "./PaginationContext"\r
...
\r
export default PaginationContent`,je=`import React from 'react'\r
...
\r
export default PaginationPrevious`,Ee=`import React from 'react'\r
import { usePagination } from './PaginationContext'\r
import { ChevronRight } from 'lucide-react'\r
\r
...
\r
export default PaginationNext`,Oe=`import React, { useCallback, useId, useState, useMemo } from "react";\r
\r
...
\r
export default RadioGroup;`,He=`import React, { useId, useEffect } from 'react';\r
...
\r
export default RadioItem;`,Le=`import { CheckCircle, Info, TriangleAlert, CircleAlert } from 'lucide-react'\r
...
\r
export default Toast`,Ve=`import React, { createContext, useContext, useMemo, useState } from 'react'\r
import type { toastType } from './types'\r
\r
interface Toast {\r
    id:string\r
...
export const useToast = () => {\r
    ...
    return context;\r
};`,ze=`import React, {useState} from 'react'\r
