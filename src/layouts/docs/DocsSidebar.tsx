...
const DocsSidebar = ({ activeSlug }: DocsSidebarProps) => {
  return (
    <nav className="flex-shrink-0 lg:w-56">
      <p className="px-3 mb-2 text-xs font-medium tracking-wide text-gray-400 uppercase">Guides</p>
      <ul className="flex flex-row gap-1 pb-2 overflow-x-auto lg:flex-col lg:overflow-visible">
        {guidesRegistry.map((entry) => (
      ...
      <p className="px-3 mt-4 mb-2 text-xs font-medium tracking-wide text-gray-400 uppercase">Components</p>
      <ul className="flex flex-row gap-1 pb-2 overflow-x-auto lg:flex-col lg:overflow-visible">
